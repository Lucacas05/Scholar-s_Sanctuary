...
export function SidebarSessionFooter() {
  return (
    <div className="space-y-1">
      <a
        href="/refinar"
        className="flex w-full items-center gap-3 p-2 text-left font-headline text-xs font-bold uppercase tracking-widest text-surface-container-highest transition hover:text-primary"
      >
        <Settings size={16} />
