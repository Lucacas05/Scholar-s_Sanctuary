    ...
    <div className="relative overflow-hidden bg-surface-container-lowest pixel-border">
      ...
      <div className="relative flex min-h-[28rem] flex-col p-5 md:min-h-[30rem] md:p-6">
        ...
        <div className="relative flex-1 overflow-hidden border border-outline-variant/35 bg-surface shadow-[0_18px_40px_rgba(0,0,0,0.22)]">
          <div className="flex h-full min-h-[20rem] items-center justify-center bg-[radial-gradient(circle_at_50%_45%,rgba(255,185,97,0.08),transparent_42%),linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0))] p-4">
            <div className="border border-primary/25 bg-black/10 p-2 shadow-[0_12px_32px_rgba(0,0,0,0.22)]">
